...
# access it here : https://github.com/marionhardy/MoMaDC_ARCHS4
```
...
length(unique(coldata$series_id))
table(coldata$series_id)
...
table(coldata$source_name)
length(unique(coldata$source_name))

table(coldata$expected_subtype)
length(unique(coldata$expected_subtype))

```

```{r}

length(unique(coldata$treatment))
table(coldata$treatment)

length(unique(coldata$length_treatment))
table(coldata$length_treatment)
